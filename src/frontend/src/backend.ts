...
export class Backend implements backendInterface {
    ...
    async getServersByCategory(arg0: string): Promise<Array<Server>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServersByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchServers(arg0: string): Promise<Array<Server>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchServers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
